...
import { METHOD_CODE, VAULT_FIELD, VAULT_PLACEHOLDER } from '@app/components/OnlinePayments/NmiPayment/nmiConfig';
import { ToastType, useToasts } from '@app/hooks/useToasts';
import useToggle from '@app/hooks/useToggle';

import { getSavedPaymentsQuery } from './sharedCc.gql';

export const useSharedVault = ({ cartId, setIsPaymentLoading, setIsPaymentDone, mutations }) => {
    ...
    const [saveVaultMethod] = useMutation(saveVault, {
        onError: error => {
