...
import { Profile as ProfileIcon, Dropdown as DropdownIcon } from '@app/components/MonumentIcons';
...
const AccountChip = props => {
    ...
    const myAccountText = formatMessage({ id: 'accountChip.myAccount', defaultMessage: 'My account' });

    return (
        <span className={classes.root}>
            <Icon src={ProfileIcon} />
            <div className={classes.wrapper}>
                <span className={classes.textSmall}>{chipText}</span>
                <div className={classes.textWrapper}>
                    <span className={classes.text}>{myAccountText}</span>
