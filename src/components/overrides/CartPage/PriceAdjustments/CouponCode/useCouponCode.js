...
import DEFAULT_OPERATIONS from '@magento/peregrine/lib/talons/CartPage/PriceAdjustments/CouponCode/couponCode.gql.js';
...
export const useCouponCode = props => {
    ...
    const handleApplyCoupon = useCallback(
            ...
            try {
                ...
                addToast({
                    ...
                    message: formatMessage({
                        id: 'coupon.success',
                        defaultMessage: 'Successfully applied coupon code.'
                    })
                });
            } catch (e) {
        ...
        [addToast, applyCoupon, cartId, formatMessage]
    );
    ...
    const handleRemoveCoupon = useCallback(
        async couponCode => {
            try {
                ...
                addToast({
                    type: ToastType.SUCCESS,
                    message: formatMessage({
                        id: 'coupon.successDelete',
                        defaultMessage: 'Successfully deleted coupon code.'
                    })
                });
            } catch (e) {
                // Error is logged by apollo link - no need to double log.
        ...
        [addToast, cartId, formatMessage, removeCoupon]
    );
