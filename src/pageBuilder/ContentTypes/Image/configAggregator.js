...
export default node => {
    ...
    const props = {
        ...
        width: Number(node.getAttribute('data-width')) || 'auto',
        height: Number(node.getAttribute('data-height')) || 'auto',
        mobileImage: imageNode[1] ? imageNode[1].getAttribute('src') : null,
        mobileWidth: Number(node.getAttribute('data-mobile-width')) || 'auto',
        mobileHeight: Number(node.getAttribute('data-mobile-height')) || 'auto',
