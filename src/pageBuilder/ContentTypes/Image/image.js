import { arrayOf, bool, oneOf, oneOfType, shape, string, number } from 'prop-types';
...
const Image = props => {
        ...
        <>
            <picture>
                ...
                <img
                    ...
                    srcSet={`${resourceUrl(desktopImage, {
                        type: 'image-wysiwyg',
                        quality: 85,
                        width: width * 2,
                        height: height * 2
    ...
    if (typeof link === 'string') {
        ...
        return (
            <figure style={figureStyles} className={[classes.root, ...cssClasses].join(' ')}>
