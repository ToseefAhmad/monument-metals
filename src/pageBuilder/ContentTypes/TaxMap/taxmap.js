...
import classes from './taxmap.module.css';

const Taxmap = () => {
    setTimeout(() => {
        const nodesWithAnchorTags = Array.from(document.querySelectorAll('[class="sales-tax-anchor"]'));
        const nodesIds = nodesWithAnchorTags.map(node => node.id);
        if (nodesWithAnchorTags) {
            nodesIds.forEach(state => {
                const element = globalThis.document.querySelector(`[data-state="${state}"]`);
                if (!element) return;
                element.style.fill = '#002147';
            });
        }
    }, 300);
    ...
    return (
        <Fragment>
            <div className={classes.fullBleedContainer}>
                <div className={classes.mapContainer}>
                    ...
                    >
                        <g>
                            ...
                            <a href="#dc">
                                <path
                                    d="m803.44,248.16l80,20a12,12 0 1,1 24,0a12,12 0 1,1 -24,0v-2l-80,-20z"
                                    stroke="#818181"
                                    strokeWidth="1"
                                    strokeLinecap="round"
                                    strokeLinejoin="round"
