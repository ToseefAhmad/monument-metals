import { arrayOf, bool, oneOf, oneOfType, shape, string, number, func } from 'prop-types';
...
const Banner = props => {
    ...
    if (!content) {
        ...
        ImageBannerFragment = (
            <img alt="Hero banner" src={src} srcSet={srcSet} width={imageWidth} height={imageHeight} />
        );
    }
