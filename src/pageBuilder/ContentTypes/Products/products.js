...
import ProductShimmer from './products.shimmer';

/**
 * Global styles for CMS block stylings
 */
import '@app/theme-monument/styles/blocks/popular-silver-coins.css';
import '@app/theme-monument/styles/blocks/explore-gold-coins.css';
import '@app/theme-monument/styles/blocks/explore-our-deals.css';
import '@app/theme-monument/styles/blocks/explore-silver-coins.css';
import '@app/theme-monument/styles/blocks/products-slider.css';
...
const Products = props => {
    ...
    if (appearance === 'carousel') {
            ...
            responsive: [
                {
                    ...
                    settings: {
                        ...
                        rows: 2,
                        slidesPerRow: slidesToShowSmall
                    }
                },
                {
                    breakpoint: 1179,
        ...
        return (
            <>
                <LazyLoad offset={10} placeholder={<ProductShimmer />}>
